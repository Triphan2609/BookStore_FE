...
const ModalAddInformations = (props) => {
    const dispatch = useDispatch();
    const { show, setShowModalAddInformations } = props;
    const [tenNhanHang, setTenNhanHang] = useState("");
    ...
    const handleClose = () => {
        ...
        setDiaChiNhanHang("");
        setSDTNhanHang("");
        setShowModalAddInformations(!show);
    };
...
export default ModalAddInformations;
